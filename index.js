  ...
  return (
    <Layout current={props.location.pathname}>
      <main>
        ...
        <p>We live during an ongoing revolution in the discovery of exoplanets–planets beyond our solar system–leaving many wondering what these worlds look like. The size of a telescope that could image an exoplanet would be unrealistically large, exceeding the size of the earth. Current propulsion technologies, such as chemical rockets and electric propulsion, are impractical to reach even the nearest exoplanets. These two factors have stimulated interest in propulsion methods that have the potential to reach the stars. Our mission is to contribute to this international effort by designing, analyzing, and testing in the lab alternative flight methods capable of achieving a significant fraction of the speed of light. Our group has a particular interest in directed energy propulsion like lightsails, intermediate steps toward this technology–such as laser-thermal propulsion–that would open our solar system, and propulsion methods that would exploit sources of energy freely available in space. Additionally, we are committed to engaging future students of science and engineering with these emerging technologies and connecting them to the international community of interstellar researchers, generating a stream of new minds aligned to realizing interstellar flight in this century.</p>
