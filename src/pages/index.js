...
export default function Home(props) {
  return (
    <Layout current={props.location.pathname}>
      <main>
        <a className="twitter-timeline" data-lang="en" data-width="300" data-height="600" data-theme="dark" href="https://twitter.com/McGill_AdAstra">Tweets by McGill_AdAstra</a>
